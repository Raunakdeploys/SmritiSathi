              ...
              {user?.isGoogleLinked ? (
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2.5 rounded-xl bg-[#002045] text-white hover:bg-[#1a365d] font-bold text-xs flex items-center gap-1.5 transition-all cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="px-3.5 py-2.5 rounded-xl bg-white hover:bg-slate-50 border-2 border-[#002045] text-[#002045] font-bold text-xs flex items-center gap-1.5 shadow-xs transition-all cursor-pointer active:scale-98"
                  >
